/**
 * This is a modified version of node-firebird library
 * The original must be replaced by this one in order to
 * work the insertion of data in SIAC database
 *
 * Don't convert param buffer to utf-8
 *
 * When a buffer is used as parameter it would always be converted to a
 * utf-8 string. To allow working with a DB that has charset NONE, the
 * buffer is now send directly without converting to string.
 */
var
    net = require('net'),
    os = require('os'),
